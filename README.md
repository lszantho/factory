...
- **[dab/backlog/rfcs/](dab/backlog/rfcs/README.md)** — design proposals for larger future work (e.g. [RFC 001: parallel task execution](dab/backlog/rfcs/rfc_001_parallel_task_execution.md)).
