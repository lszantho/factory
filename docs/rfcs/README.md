...
| [005](RFC_005_SPRINT_ORIENTED_PLANNING.md) | Sprint-oriented planning | Proposed — all rollout steps (0-3) landed: rename, dab invariant, decide() simplification, portfolio view progress fix |
